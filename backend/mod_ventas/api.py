...
from shared.cache import get_carrito, set_carrito, get_sesion
...
@app.route("/api/ventas/carrito/item/<juego_id>", methods=["DELETE"])
...
@app.route("/api/ventas/ordenes", methods=["GET"])
